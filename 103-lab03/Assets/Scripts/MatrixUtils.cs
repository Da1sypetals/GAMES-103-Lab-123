...
namespace MatrixUtils {
    ...
    public struct Matrix3 {
        ...
        public (Vector3, Vector3, Vector3) DeconstructColumns() {
            Vector3 column1 = new Vector3(m00, m10, m20);
            Vector3 column2 = new Vector3(m01, m11, m21);
            Vector3 column3 = new Vector3(m02, m12, m22);
        ...
        public (Vector3, Vector3, Vector3) DeconstructRows() {
            Vector3 row1 = new Vector3(m00, m01, m02);
            Vector3 row2 = new Vector3(m10, m11, m12);
            Vector3 row3 = new Vector3(m20, m21, m22);

            return (row1, row2, row3);
        }

        public static Matrix3 Diagonal(float d0, float d1, float d2) {
            return new Matrix3(
                d0,
                0f,
                0f,
